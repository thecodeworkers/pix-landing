...
const SendIcon = () => (
  ...
  <g id="Grupo_307" data-name="Grupo 307" transform="translate(11.908 8.802)">
    ...
    <text id="Transferir" transform="translate(6.592 70.698)" fill="#444457" font-size="13" font-family="Muli-Bold, Muli" font-weight="700"><tspan x="21.6" y="13">Transferir</tspan></text>
  </g>
</svg>
)
