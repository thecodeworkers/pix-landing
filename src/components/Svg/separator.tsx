...
<svg width="515" height="10" viewBox="0 0 515 10">
  ...
  <g id="Grupo_163" data-name="Grupo 163" transform="translate(-716.111 -531)">
    <rect id="Rectángulo_1564" data-name="Rectángulo 1564" width="129" height="10" transform="translate(716.111 531)" fill="url(#linear-gradient)"/>
    <rect id="Rectángulo_1565" data-name="Rectángulo 1565" width="128" height="10" transform="translate(845.111 531)" fill="url(#linear-gradient-2)"/>
    <rect id="Rectángulo_1566" data-name="Rectángulo 1566" width="129" height="10" transform="translate(973.111 531)" fill="url(#linear-gradient-3)"/>
