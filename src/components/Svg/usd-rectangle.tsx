...
<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 393 120">
  ...
  <g id="Grupo_566" data-name="Grupo 566" transform="translate(22.456 19.382)">
    ...
    <text id="Enviar_USD" data-name="Enviar USD" transform="translate(177.269 30.16)" fill="#4b677d" font-size="14" font-family="Muli-SemiBold, Muli" font-weight="600"><tspan x="20.776" y="14">Enviar USD</tspan></text>
