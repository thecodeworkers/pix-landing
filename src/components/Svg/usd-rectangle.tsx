...
<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 393 120">
  <defs>
    ...
    <filter id="RectánguloUSD_1635" x="0" y="0" width="393" height="120" filterUnits="userSpaceOnUse">
      <feOffset dy="3" />
  ...
  <g id="GrupoUSD_566" data-name="GrupoUSD 566" transform="translate(22.456 19.382)">
    <g transform="matrix(1, 0, 0, 1, -22.46, -19.38)" filter="url(#RectánguloUSD_1635)">
      <rect id="RectánguloUSD_1635-2" data-name="RectánguloUSD 1635" width="348" height="75" rx="8" transform="translate(370.5 94.5) rotate(180)" fill="url(#usd-rectangle)"/>
    </g>
    <g id="GrupoUSD_159" data-name="GrupoUSD 159" transform="translate(5.51 5.068)">
      <rect id="RectánguloUSD_181" data-name="RectánguloUSD 181" width="68" height="66" rx="7" transform="translate(-0.466 0.05)" fill="url(#usd-rectangle-2)"/>
      <rect id="RectánguloUSD_183" data-name="RectánguloUSD 183" width="65" height="63" rx="6" transform="translate(2.534 0.05)" fill="url(#radial-gradient)"/>
    </g>
