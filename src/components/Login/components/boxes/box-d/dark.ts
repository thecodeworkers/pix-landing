...
const linearOneId = 'linear-one-box4';
const linearTwoId = 'linear-two-box4';
const linearThreeId = 'linear-three-box4';
const linearFourId = 'linear-four-box4';
const linearFiveId = 'linear-five-box4';
const linearSixId = 'linear-six-box4';
