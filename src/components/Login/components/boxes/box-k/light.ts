...
const linearOneId = 'linear-one-box11';
const linearTwoId = 'linear-two-box11';
const linearThreeId = 'linear-three-box11';
const linearFourId = 'linear-four-box11';
const linearFiveId = 'linear-five-box11';
const linearSixId = 'linear-six-box11';
