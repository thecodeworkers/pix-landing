...
const linearOneId = 'linear-one-box9';
const linearTwoId = 'linear-two-box9';
const linearThreeId = 'linear-three-box9';
const linearFourId = 'linear-four-box9';
const linearFiveId = 'linear-five-box9';
const linearSixId = 'linear-six-box9';
