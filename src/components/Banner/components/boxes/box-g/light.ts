...
const linearOneId = 'linear-one-box7';
const linearTwoId = 'linear-two-box7';
const linearThreeId = 'linear-three-box7';
const linearFourId = 'linear-four-box7';
const linearFiveId = 'linear-five-box7';
const linearSixId = 'linear-six-box7';
