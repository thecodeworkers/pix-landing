...
const linearOneId = 'linear-one-box3';
const linearTwoId = 'linear-two-box3';
const linearThreeId = 'linear-three-box3';
const linearFourId = 'linear-four-box3';
const linearFiveId = 'linear-five-box3';
const linearSixId = 'linear-six-box3';
