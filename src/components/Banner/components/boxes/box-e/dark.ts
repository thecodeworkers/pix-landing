...
const linearOneId = 'linear-one-box5';
const linearTwoId = 'linear-two-box5';
const linearThreeId = 'linear-three-box5';
const linearFourId = 'linear-four-box5';
const linearFiveId = 'linear-five-box5';
const linearSixId = 'linear-six-box5';
