...
const linearOneId = 'linear-one-box6';
const linearTwoId = 'linear-two-box6';
const linearThreeId = 'linear-three-box6';
const linearFourId = 'linear-four-box6';
const linearFiveId = 'linear-five-box6';
const linearSixId = 'linear-six-box6';
